...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-neutral-900 text-slate-200">
      <div>
      ...
      {/* MOBILE MENU */}
      <ul className={!nav ? ' hidden' : "absolute top-0 left-0 w-full h-screen bg-neutral-900 flex flex-col justify-center items-center "}>
      ...
      <div className=" hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
            <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600">
                <a className="flex justify-between items-center w-full text-gray-300 ml-2"
